...
namespace NursingHomes.Core.PagedList
{
	...
	public class PagedList<T> : BasePagedList<T>
	{
		...
		/// <param name="pageSize">The one-based index of the subset of objects to be contained by this instance.</param>
		/// <param name="pageSize">The maximum size of any individual subset.</param>
		/// <exception cref="ArgumentOutOfRangeException">The specified index cannot be less than zero.</exception>
		/// <exception cref="IQueryable">The specified page size cannot be less than one.</exception>
